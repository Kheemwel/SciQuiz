...
import com.CrimsonKnightBlood.SciQuiz.Quiz.MCEarthScienceChoices;
import com.CrimsonKnightBlood.SciQuiz.Quiz.MCAnswers;
public class EarthScienceMC extends Activity
{
	...
	private MCEarthScienceChoices C = new MCEarthScienceChoices();
	...
	private void SAVE() {
		if(scr > sp.getInt("earth_mcscore", 0)) {
			editor.putInt("earth_mcscore", scr);
			editor.commit();
		}
	}
		...
		build
			...
			.setPositiveButton("Retry", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface di, int i) {
					startActivity(new Intent(getApplicationContext(), EarthScienceMC.class));
					finish();
				}
			})
